...
export const REGION_TERRAIN_MASKS: Partial<Record<WorldRegionId, readonly string[]>> = {
  ...
  // Forest borders the coarse rects miss (left/bottom/right pine walls) plus the
  // high-confidence leafy trees standing on open grass. Gate arrivals kept open:
  // {13,19} from forest, {29,14} from mine, down-gate x12-14.
